...
import net.htlgkr.SaurerP190201.hue3Saurer.*;
...
public class StreamsTest {
    ...
    public void setUp() throws IOException {
        weapons = readFile("src/weapons.csv");
    }
    ...
    public void test13()  throws Throwable  {
        ...
        assertEquals(1552, weapon1.getStrengt());
    }
    ...
    public void test17()  throws Throwable  {
        ...
        linkedList0.add(weapon0);
        Weapon weapon1 = streams0.findWeaponWithLongestName(linkedList0);
        assertEquals(1, weapon1.getStrengt());
    }
    ...
    @Test(timeout = 4000)
    public void eigenertest1()  throws Throwable  {
        Main m = new Main();
        m.sortfordamage();
        assertTrue(true);
    }
    ...
    @Test(timeout = 4000)
    public void eigenertest2()  throws Throwable  {
        Main m = new Main();
        m.sortforcombatType();
        m.sortfordamageType();
        m.sortforname();
    ...
    @Test(timeout = 4000)
    public void eigenertest3()  throws Throwable
    {
        ...
        arr[1]=12;
        arr[2]=3;
        double e = s.average(arr);
        assertEquals(e,7.0, 0);
    }

    @Test(timeout = 4000)
    public void eigenertest4()  throws Throwable  {
        Streams s = new Streams();
        String[] arr = new String[3];
        arr[0]="s";
        arr[1]="v";
        arr[2]="r";
        List<String> upping = s.upperCase(arr);
        List<String> expect = List.of("S", "V", "R");
        assertEquals(expect,upping);
    }
}
